...
create function public.admin_void_sale_event(
  p_event_id uuid,
...
begin
  ...
  insert into public.stock_snapshots as ss (product_id, stock)
  ...
  insert into public.inventory_events as ie (
    product_id,
    type,
    qty_change,
    status,
  ...
  returning ie.id into v_adjustment_event_id;
